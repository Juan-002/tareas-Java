...
<%@ page import="co.edu.poli.ces3.universitas.logica.Usuario" %>
                ...
                <div class="modal-background">
                    <div class="modal-content">
                        ...
                        <form id="userForm" action="user" method="POST">
                            ...
                            <p style="color: #ffff" > la compañia Universitas no se hace responsable de los datos digitados en este formulario</p>
                        </form>
                    </div>
                </div>
            </div>

            <a class="tag is-danger is-large" id="btnEliminar"> Eliminar Usuario </a>
            <!-- Modal -->
            <div id="modalEliminar" class="modal">
                <div class="modal-background">
                    <div class="modal-content">
                        <span class="closeEliminar"><button class="delete is-medium"></button></span>
                        <form id="eliminarForm" action="SvEliminar" method="">
                            <p style="color: #ffff"><label> ID: </label> <input type="text" name="id" id="id_usuario" class="content"> </p>
                            <input class="tag is-danger is-large" type="submit" value="Eliminar"> <br>
                            <p style="color: #ffff" >Eliminando aqui por ID eliminara todo el registro de ese ID, Seguro que lo quiere hacer?</p>
                        </form>
                    </div>
                </div>
            </div>
...
<script>
    ...
    let spanCerrar = document.getElementsByClassName("close")[0];
...
<script>
    let modal2 = document.getElementById("modalEliminar");
    let Eliminar = document.getElementById("btnEliminar");
    let spanCerrarEliminar = document.getElementsByClassName("closeEliminar")[0];
